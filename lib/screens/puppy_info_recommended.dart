...
class Puppyinfo extends StatefulWidget {
  const Puppyinfo({Key? key, required this.petName, required this.petImage})
      : super(key: key);
  ...
  @override
  State<Puppyinfo> createState() => _PuppyinfoState();
}

class _PuppyinfoState extends State<Puppyinfo> {
