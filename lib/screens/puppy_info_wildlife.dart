...
class PuppyinfoWild extends StatefulWidget {
  const PuppyinfoWild({Key? key, required this.petName, required this.petImage})
      : super(key: key);
  ...
  @override
  State<PuppyinfoWild> createState() => _PuppyinfoWildState();
}

class _PuppyinfoWildState extends State<PuppyinfoWild> {
